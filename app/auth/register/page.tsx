  ...
  return (
    <main className="mx-auto max-w-md px-4 py-12 sm:px-6 lg:px-8">
      <div className="rounded-3xl border bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-sm text-foreground/70">Create your account (demo for preview).</p>
        ...
        <p className="mt-6 text-center text-sm text-foreground/70">
          New here?{" "}
          <Link className="font-medium text-gold-700 hover:text-gold-800" href="/auth/login">
            Login
          </Link>
        </p>
      </div>
